...
fn main() { // main function
    ...
    let secret_number = rand::thread_rng().genrange(1..=100); //i see no mut meaning the variable is not going to change during the program. calls on the random library and uses rng to generate no from 1 - 100 using .genrange(1..=100) method
